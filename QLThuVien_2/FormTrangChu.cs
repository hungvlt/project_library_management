...
namespace QLThuVien_2
{
  public partial class FormTrangChu : Form
  {
    ...
    {
      btnBaoCaoThongKe.BackColor = Color.FromArgb(70, 130, 180);
    }

    private void btnBaoCao_MouseLeave(object sender, EventArgs e)
    {
      btnBaoCaoThongKe.BackColor = Color.FromArgb(100, 149, 237);
    }

    private void btnMuonTra_MouseEnter(object sender, EventArgs e)
    {
      btnMuonTraSach.BackColor = Color.FromArgb(70, 130, 180);
    }

    private void btnMuonTra_MouseLeave(object sender, EventArgs e)
    {
      btnMuonTraSach.BackColor = Color.FromArgb(100, 149, 237);
    }
